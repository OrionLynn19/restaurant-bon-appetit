...
export default function DeliForm({
  ...
  return (
    <section
      className={`font-['Schibsted_Grotesk'] w-full max-w-[598px] ${className}`}
    >
        ...
        <div className="flex items-center gap-3">
          ...
          {editing ? (
            <input
              ...
              className="min-w-0 flex-1 truncate text-[14px] md:text-[20px] leading-7 text-[#0D4A3E] p-0 focus:outline-none"
            />
          ) : (
            <span
              className="flex-1 truncate text-[14px] md:text-[20px] leading-7 text-[#0D4A3E]"
        ...
        <div className="relative">
          ...
          >
            <div className="flex min-w-0 items-center gap-3">
              ...
              <span
                className={`truncate text-[14px] md:text-[20px] leading-7 text-[#0D4A3E]`}
              >
          ...
          >
            ...
            >
              ...
              <span className="text-[14px] md:text-[20px] leading-7 text-[#0D4A3E]">
                Place At Given Spot
              </span>
            </button>
            <button
